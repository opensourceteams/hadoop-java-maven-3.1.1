 ...
 *  idea中直接提交到集群中
 */
public class WordCountLocalSubmitLocalCombiner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if(args == null || args.length < 2){
             ...
             outerPath = "E:/temp/data/worldcount/output_mapreduce_combiner";
        }else{
            inputPath = args[0];
            outerPath = args[1];
        }
        ...
        job.setJarByClass(WordCountLocalSubmitLocalCombiner.class);
